          ...
          {TESTIMONIALS.map((t, i) => {
            ...
            return (
              ...
              >
                ...
                <p className="text-sm lg:text-base text-gls-text leading-relaxed">"{t.quote}"</p>
                <div className="mt-6 pt-5 border-t border-gls-border flex items-center gap-3">
                  ...
                  <div>
                    <div className="font-display font-bold text-gls-navy text-sm">{t.company}</div>
                    <div className="text-xs text-gls-muted">{t.author}</div>
                  </div>
                </div>
              </motion.div>
            );
